...
const QualifiedMentorsDisplay = () => {
  ...
  const mentors = (mentorsResp?.mentors || []).slice(0, 4);

  // Duplicate mentors for infinite carousel scroll
  const displayMentors =
    mentors.length > 0 ? Array(8).fill(mentors).flat() : [];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto text-slate-600 text-base md:text-lg leading-relaxed">
            Learn from the best. Our highly qualified and experienced faculty
            members are dedicated to guiding you towards your dream career.
          </p>
        </div>
